...
// let removePInNav = document.querySelector("nav").firstElementChild;
// document.querySelector("nav").removeChild(removePInNav);
...
// document.querySelector(`orderedList`).textContent = "Not Home";
// // add the li elements to the ul in the nav-bar
// document.querySelector("#nav-bar").appendChild(orderedList);
