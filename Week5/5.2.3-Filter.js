...
let incomplete = data.filter(status => status.completed == false);
// console.log(incomplete);
// filter for user 6's tasks
let tasksOf6 = data.filter(tasks => tasks.userId == 6);
// console.log(tasksOf6);

// filter for user 6's incomplete tasks
let incompleteTasksOf6 = tasksOf6.filter(tasks => tasks.completed != true);
// console.log(incompleteTasksOf6);

// filter for tasks with a title less than 24 characters long
const shortTitles = data.filter(tasks => tasks.title.length < 24);
